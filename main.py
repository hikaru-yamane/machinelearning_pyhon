...
# Ctrl+1: コメントアウト/アンコメント
# Tab/Shift+Tab: 字下げ/字下げを戻す
# Ctrl+F10: ステップ実行
# Ctrl+C: 無限ループの強制終了

# データ全体をシャッフルすると，ハイパーパラメータを調整して精度が上がったのか，たまたまテストデータとの相性が良くて精度が上がったのか分からなくなる
# 大本のデータはシャッフルして保存しておき，読み込み後はシャッフルしない
