...
#            self.layers['BN0_'+str(i)] = batch_normalization(n['0_'+str(i)], minibatch_size)
#            self.layers['BN0_'+str(i)] = batch_normalization_book(np.ones((1,n['0_'+str(i)]),'float32'),np.zeros((1,n['0_'+str(i)]),'float32'))
...
#            self.layers['BN1_'+str(i)] = batch_normalization(n['1_'+str(i)], minibatch_size)
#            self.layers['BN1_'+str(i)] = batch_normalization_book(np.ones((1,n['1_'+str(i)]),'float32'),np.zeros((1,n['1_'+str(i)]),'float32'))
...
#        self.layers['conv_3'] = convolution(params['conv_3']['mf'], params['conv_3']['cf'], params['conv_3']['hf'], params['conv_3']['wf'], params['conv_3']['pad'], params['conv_3']['stride']) # simple cnn
...
#        self.layers['actfunc_3'] = relu() # simple cnn
#        self.layers['pool_3'] = pooling(params['pool_3']['hf'], params['pool_3']['wf'], params['pool_3']['stride']) # simple cnn
